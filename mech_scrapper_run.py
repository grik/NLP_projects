...
# TODO: PEP8 styling
# TODO: More advenced menu.
# TODO: Proper comments!
# FIXME: Error handling when story is empty (HTTP request denied).
...
if __name__ == '__main__':
    ...
    print('=======================================================')
    print("Status:")
    print("Links on website:", len(scrap.links))
    print("Links on HDD:", len(scrap.links) - len(scrap.checkfiles()), "\n")
    print("You have {} links left to scrap.".format(len(scrap.checkfiles())))
    print('=======================================================')
